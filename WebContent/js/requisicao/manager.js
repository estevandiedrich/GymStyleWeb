...
//var TEMP = 40;//equivalente a 10s para uma atualização de um destino apenas
var TEMP = 70;//equivalente a 17,5s para uma atualização de um destino apenas
