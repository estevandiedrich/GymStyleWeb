...
<div >
    <table style="width: 410px;height: 210px">
        <tr>
            <td>
                <h1>Pagamento de parcelas</h1>
            </td>
        </tr>
        <tr>
            <td class="one" valign="top" style="height: 40%;">
                <h3></h3>
        ...
        <tr>
            <td align="left" >
                <div class="errors" id="msgStatusImprimir" style="width: 400px;margin-left: 2px;font-size: 15px">O comprovante não será impresso!</div><br>
            </td>
        </tr>

    </table>
    <table style="width: 390px;padding-left: 8px">
        <tr>
            <td width="100%">
