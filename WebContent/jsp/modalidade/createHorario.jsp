...
<table width="100%">
    <tr>
        <td width="100%">            
            <h1 id="eventoImportar"  class="mais"  title="Selecione">Selecionar um horário cadastrado</h1>
            <fieldset id="importar" <c:if test="${horariosUm}">style="display: inline"</c:if> class="field">
                <legend></legend>
                <div>
                    <table width="98%" align="center" class="faixasForm">
                        <tr>
                            <td width="10%" class="one">
                                <mtw:label klass="obrig" value="Horários:"/>
                            </td>
                            <td width="25%">
                                <mtw:select list="horarios" klass="selectOptions" name="horarioSelect" id="horarioSelect" emptyField="true" emptyFieldValue="Selecione..."/>
                            </td>
                ...
                <div id="corpoHorarios" >
                    <c:if test="${onload}"><%@include file="horarioForm.jsp" %></c:if>
                </div>
            </fieldset>
        </td>
    </tr>
