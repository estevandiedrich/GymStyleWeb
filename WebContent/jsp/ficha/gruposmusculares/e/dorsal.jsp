    ...
    <td width="88%" valign="top">
        <div class="faixasForm" style="width: 99.5%;margin-left: 1px;background-color: #ffffff">
            <table width="100%" >
                <tr>
                    <td width="90%" >
                        <h1 id="dorsal-e" class="mais" title="Selecione!">Dorsal</h1>
                    </td>
                    <td width="10%" align="center" ><h4>Treino E</h4></td>
                </tr>
            </table>
            <div id="div-dorsal-e" class="grupo">
                <table width="100%" class="displaytag">
                    ...
                    <tbody>
                        ...
                        <input name="idsDorsal-e" id="idsDorsal-e" type="hidden" value="<mtw:loop var="row" counterStart="0" counter="i"><mtw:out value="id"/>-</mtw:loop>">
