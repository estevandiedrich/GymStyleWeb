    ...
    <td width="100%" valign="top">
        ...
        <div class="faixasForm" style="width: 99.5%;margin-left: 1px;background-color: #ffffff">
            <table width="100%" >
                <tr>
                    <td width="90%" >
                        <h1 id="peitoral-a" class="mais" title="Selecione!">Peitoral</h1>
                    </td>
                    <td width="10%" align="center" ><h4>Treino A</h4></td>
                </tr>
            </table>
            <div id="div-peitoral-a" class="grupo">
                        ...
                        <mtw:list value="peitoral" var="pojo">
                            ...
                            <mtw:loop var="row" counterStart="0" counter="i">
                                <tr class="
                                    ...
                                    <td align="center" class="columnErrorq" ><div id="${row.id}exercicio-error-a" ></div></td>
                                </tr>
                            </mtw:loop>
                        </mtw:list>
                    </tbody>
