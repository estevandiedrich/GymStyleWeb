    ...
    <td width="88%" valign="top">
        <div class="faixasForm" style="width: 99.5%;margin-left: 1px;background-color: #ffffff">
            <table width="100%" >
                <tr>
                    <td width="90%" >
                        <h1 id="gastrocnemicos-d" class="mais" title="Selecione">Gastrocnêmicos</h1>
                    </td>
                    <td width="10%" align="center" ><h4>Treino D</h4></td>
                </tr>
            </table>
            <div id="div-gastrocnemicos-d" class="grupo">
                <table width="100%" class="displaytag">
                    ...
                    <tbody id="tBody">
                        ...
                        <input name="idsGastronemicos-d" id="idsGastronemicos-d" type="hidden" value="<mtw:loop var="row" counterStart="0" counter="i"><mtw:out value="id"/>-</mtw:loop>">
