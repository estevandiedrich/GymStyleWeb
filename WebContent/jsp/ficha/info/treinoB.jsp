                            ...
                            <mtw:loop var="row" counterStart="1" counter="i">
                                <tr class="
                                    ...
                                    <mtw:if test="row.exercicio.grupoMuscular.grupoMuscular" value="null" negate="true">
                                        <td rowspan="<mtw:out value="rowGrupoB${row.exercicio.id}"/>"
                                            class="<mtw:if test="corB${row.exercicio.id}" value="1" >color1</mtw:if><mtw:if test="corB${row.exercicio.id}" value="2" >color2</mtw:if>" >
