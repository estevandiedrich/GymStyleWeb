                            ...
                            <mtw:loop var="row" counterStart="1" counter="i">
                                <tr class="
                                    ...
                                    <mtw:if test="row.exercicio.grupoMuscular.grupoMuscular" value="null" negate="true">
                                        <td rowspan="<mtw:out value="rowGrupoD${row.exercicio.id}"/>"
                                            class="<mtw:if test="corD${row.exercicio.id}" value="1" >color1</mtw:if><mtw:if test="corD${row.exercicio.id}" value="2" >color2</mtw:if>" >
