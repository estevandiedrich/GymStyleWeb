...
<div class="title_bottom">
    ...
    <h3>Editar</h3>
    <mtw:form method="post" action="perfilAcessoUpdate.do">
        <mtw:bean value="pojo">
            ...
            <table width="98%" align="center" class="faixasForm">
                <tr>
                    <td class="chek">
                        <INPUT TYPE="checkbox" NAME="todos" id="todos" <c:if test="${todos}">checked="true"</c:if>  onclick="eventoTodosAplicarFaixas()" /> <mtw:label value="Todos"/>
                    </td>
                    <td>
                        <h4>1°Período</h4>
                    </td>
                ...
                <tr>
                    <td class="chek">
                        <INPUT TYPE="checkbox" NAME="terca"  id="terca" <c:if test="${terca}">checked="true"</c:if>  VALUE="0"/> <mtw:label  value="Terça"/>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="chek">
                        <INPUT TYPE="checkbox" NAME="quarta"  id="quarta" <c:if test="${quarta}">checked="true"</c:if> VALUE="0"/> <mtw:label  value="Quarta"/>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="chek">
                        <INPUT TYPE="checkbox" NAME="sexta"  id="sexta" <c:if test="${sexta}">checked="true"</c:if>  VALUE="0"/> <mtw:label  value="Sexta"/>
                    </td>
                    <td>
