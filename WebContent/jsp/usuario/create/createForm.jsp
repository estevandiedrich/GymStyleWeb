...
<div class="title_bottom">
    ...
    <h3>Novo</h3>
    <mtw:form method="post" action="usuarioCreateInformacao.do" name="formUsuario" >
        <table width="100%">
            <tr>
                <td width="100%">
            ...
            <tr>
                <td class="title_bottom">
                    ...
                    <mtw:buttonAction klass="aba" action="usuarioCreateInformacao.do?acao=identificacao" id="eventoIdentificacao" name="proximo" value="Identificação"/>
                    <input class="abaDisabled" id="eventoPlanos" type="button"  value="Planos"  />
                </td>
            </tr>
            <tr>
                <td>
                            ...
                            <tr>
                                <td width="100%">
                                    ...
                                    <fieldset id="foto" class="field">
                                        ...
                                        <h3></h3>
                                        <div>
                                            <iframe src="usuarioCreateInformacao.definir.do" width="100%" 
            ...
            <tr>
                <td width="100%" class="panelButtonForm">
                    <mtw:buttonAction action="usuarioRead.do" klass="botao" name="Cancelar" value="Cancelar"/>
                    <mtw:buttonAction klass="botaoDes" name="anterior" disabled="true" value="Anterior" />
                    <mtw:buttonAction klass="botao" action="usuarioCreateInformacao.do?acao=identificacao" name="proximo" value="Próximo"/>
