...
<script type="text/javascript" src="js/usuario/update/informacoes.js"></script>

<div class="title_bottom">
    <mtw:form method="post" action="usuarioUpdateInformacao.do" name="form">
        <mtw:bean value="pojo">
            ...
            <table width="100%">
                ...
                <tr>
                    <td class="title_bottom">
                        ...
                        <mtw:buttonAction klass="aba" action="usuarioUpdateInformacao.do?acao=identificacao" id="eventoIdentificacao" name="identificacao" value="Identificação"/>
                                                    ...
                                                    <td width="100%">
                                                        ...
                                                        <fieldset id="foto" class="field">
                                                            ...
                                                            <div style="display: inline">
                                                                <h3></h3>
                                                                <iframe src="usuarioUpdateInformacao.definir.do" width="100%" 
                ...
                <tr>
                    <td width="100%" class="panelButtonForm">
                        ...
                        <mtw:buttonAction klass="botao" action="usuarioUpdateInformacao.do?acao=identificacao" name="proximo" value="Próximo"/>
