...
<script type="text/javascript" src="js/usuarioplano/infoPlanoUsuario.js"></script>

<div class="faixasForm">
    <mtw:bean value="infoPlano">
        <h3></h3>
        <table width="100%" align="center" style="height: 30px" class="form">
            <tr>
                <td align="center" width="10%" valign="middle" >
                    <font id="eventoDetalhesPlano" class="mais" title="Visualizar detalhes!" style="font-weight: bold">Plano:</font>
                </td>
                <td align="left" width="40%">
                    <label title="<mtw:out value="plano"/>!"><mtw:out value="plano" max="30"/></label>
                </td>
            ...
            <div class="faixasForm">
                ...
                <table width="100%" class="displaytag">
                    ...
                    <tr class="odd">
                        ...
                        <td align="center" width="25%" >
                            <!--mtw:input type="hidden" name="valorTotal" id="valorTotal"/-->
                            <mtw:out value="valorTotal" formatter="realFormatter" />
                        </td>
                    </tr>
                </table>
                <table width="100%" class="displaytag">
                    ...
                    <tr class="even">
                        <td align="center" >
                            <mtw:textarea klass="info" name="observacao" id="observacao" cols="100" rows="7" style="max-width: 600px;max-height: 200px" />
                        </td>
                    </tr>
                </table>
