                    ...
                    <tr class="
                        ...
                        <td align="center" width="50%">
                            <mtw:if test="i" value="1" negate="false">
                                <input name="valorTotal${i}"  id="valorTotal${i}" value="<mtw:out value="pojo.valor" formatter="realFormatter" />" class="inputNumber" textAlign="right" title="Valor da parcela mais a matricula." />
                            </mtw:if>
                            <mtw:if test="i" value="1" negate="true">
                                <input name="valorTotal${i}"  id="valorTotal${i}" value="<mtw:out value="pojo.valor" formatter="realFormatter" />" class="inputNumber" textAlign="right" />
                            </mtw:if>
                            <div id="error${i}"/>
                        </td>
                    </tr>
