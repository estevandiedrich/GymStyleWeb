...
<script src="js/funcionario/create.js"></script>
...
<div class="title_bottom">
    ...
    <h3>Novo</h3>
    <mtw:form method="post" action="funcionarioCreateInformacao.do" name="formUsuario" >
        <table width="100%">
            <tr>
                <td width="100%">
                    ...
                    <mtw:input type="hidden" name="var6" id="var6" value="1" />
                </td>
            </tr>
            <tr>
                <td class="title_bottom">
                    <input class="abaCurrent" id="eventoInformacoes" type="button" value="Informações" />
                    <mtw:buttonAction klass="aba" id="eventoIdentificacao" action="funcionarioCreateInformacao.do?acao=identificacao" name="identificacao" value="Identificação"/>
                    <input class="abaDisabled" id="eventoPlanos" type="button"  value="Acesso" />
                </td>
            </tr>
            <tr>
                <td>
                            ...
                            <tr>
                                <td width="100%">
                                    ...
                                    <fieldset id="foto" class="field">
                                        ...
                                        <h3></h3>
                                        <div>
                                            <iframe src="funcionarioCreateInformacao.definir.do" width="100%" 
            ...
            <tr>
                <td width="100%" align="center">
                    <div width="100%" class="panelButtonForm" >
                        ...
                        <mtw:buttonAction klass="botao" action="funcionarioCreateInformacao.do?acao=identificacao" name="proximo" value="Próximo"/>
