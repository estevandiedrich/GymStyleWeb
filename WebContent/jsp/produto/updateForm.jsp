...
<script src="js/produto/updateForm.js"></script>
...
<div class="title_bottom">
    ...
    <h3>Editar</h3>
    <mtw:form method="post" action="produtoUpdate.do" klass="faixasForm" >
        <mtw:bean value="pojo">
                            ...
                            <div class="faixasForm" style="width: 320px;height:200px;">
                                ...
                                <table width="100%">
                                    <tr>
                                        <td width="100%">
                                    <legend></legend>
                                    <iframe src="produtoUpdate.definir.do" width="100%" height="195" 
