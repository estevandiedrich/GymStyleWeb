...
<div class="title_bottom">
    ...
    <h3>Novo</h3>
    <mtw:form method="post" action="fornecedorCreate.do">
        <mtw:bean value="pojo">
            <table width="80%" class="faixasForm">
                ...
                <tr>
                    <td width="10%" class="one"><mtw:label klass="obrig" value="Nome:"/></td>
                ...
                <tr>
                    <td class="one"><mtw:label klass="obrig" value="Cidade:"/></td>
                ...
                <tr>
                    <td class="one"><mtw:label klass="obrig" value="Estado:"/></td>
                ...
                <tr>
                    <td class="one"><mtw:label klass="obrig" value="Telefone:"/></td>
                    <td>
